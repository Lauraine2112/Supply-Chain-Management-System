...
/**
 * OrderForm is a class that is responsible for creating and deleting a text file called
 * orderForm.txt. It is also responsible for creating the appropriate string output 
 * message. This class utilizes the data from LocateRequest.
 */
