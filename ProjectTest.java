...
/**
 * ProjectTest is a class that performs JUnit testing to ensure
 * that all project functionalities are fulfilled. 
 * There are 20 different unit tests that demonstrate that the 
 * main program executes properly.
 */
