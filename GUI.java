 ...
 * allow the user to input their order in an alternative way to the terminal.
 * It has one constructor that creates the panels for the user inputs.
 */
public class GUI {
	...
	private String[] startOptions = { "Yes, please start!", "No, I want to exit." }; //options for buttons on the starting pane
	...
	public GUI() {
		...
		int passwordInt = JOptionPane.showOptionDialog(null, obj, "Input", 
				JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, null, pfOptions, pfOptions[0]); //mysql password
