...
public class ProjectTest {
	...
	public void aCheckUserInputFurniture() {
		new LocateRequest(DBURL, USERNAME, PASSWORD, "chair", "Mesh", 1);
	...
	public void dCheckCorrectTotalPrice() {
		...
		assertEquals("Total price was incorrect: ", 200, myRequest.getTotalPrice());
	}
	...
	public void hTotalPriceForOrderWithExtraParts() {
		...
		LocateRequest.getConnect().initializeConnection();
		myRequest.getRequest();
		assertEquals("Total price with extra parts was incorrect: ", 1200, myRequest.getTotalPrice());
	}
...
//	 Database should remain the same. No order form should be made.
	...
	// furniture. No changes made to the database. No order form should be created.
	...
	@Test
	// Expects an error message to be printed to the command-line due to invalid
	// type. No changes made to the database. No order form should be created.
	...
	@Test
	// Expects an error message to be printed to the command-line due to invalid
	// amount. No changes made to the database. No order form should be created.
