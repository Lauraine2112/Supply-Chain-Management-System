 ...
 * exceptions and invalid inputs from being executed to the program. It
 * validates that the furniture category and type exist and correspond to each
 * other. It also checks if an input is a numeric value and if it is larger than 0.
 */
public class Input {
	/**
