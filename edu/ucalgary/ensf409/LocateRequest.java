...
/**
 * LocateRequest is a class that is responsible for searching and finding the
 * best permutation of furniture pieces from the database, inventory. If the
 * cheapest permutation is found, it is used in the output message and
 * orderForm.txt file. If a completed furniture piece is not possible, an output
 * message with the suggested manufactures is outputted and no orderForm.txt is
 * created. This class utilizes classes OrderForm, Connect, and Input in its
 * execution.
 */
